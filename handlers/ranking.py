...
async def rank(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    all_players = db.army.get_all_values()[1:]  # Skip header row

    if not all_players:
        return await update.message.reply_text("🏆 No Commanders found yet!")
    ...
    for player in all_players:
        try:
            ...
            commander_name = db.get_player_data(telegram_id)["PlayerName"]
    ...
    rank_text = "🏆 **SkyHustle Top Commanders** 🏆\n\n"
    ...
    rank_text += "\n🛡️ Keep forging your empire, Commander!"
