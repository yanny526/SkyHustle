...
async def status(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ── Player & tutorial handling (unchanged) ────────────────────────────────
    ...
    # **← these now reflect real levels from CompletedBuilds**
    ...
    # Supply-tick countdown (unchanged)…
    tick_str = ""
    ...
    for b in all_bld:
        ...
        gain_str    = f"+{prod_info[1] * nl - prod_info[1] * lvl} {prod_info[0]}/min" if prod_info else "–"
        lines.append(
