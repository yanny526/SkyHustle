# constants.py
# This is the complete and correct version for System 3.
# Please replace the entire file content with this blueprint.
...
BUILDING_DATA = {
    'hq': {
        'id': 'building_hq_level', 'name': 'Command HQ', 'emoji': '🏛️',
        'description': 'The heart of your base. Upgrading unlocks new buildings and features.',
        'base_cost': {'wood': 100, 'stone': 100}, 'cost_multiplier': 2.5,
        'base_time_seconds': 60, 'time_multiplier': 2, 'effects': {}
    },
    'barracks': {
        'id': 'building_barracks_level', 'name': 'Barracks', 'emoji': '🪖',
        'description': 'Allows training of military units. Upgrading unlocks new units and increases training queue size.',
        'base_cost': {'wood': 200, 'stone': 100}, 'cost_multiplier': 2.0,
        'base_time_seconds': 90, 'time_multiplier': 1.8, 'effects': {}
    },
    'warehouse': {
        'id': 'building_warehouse_level', 'name': 'Warehouse', 'emoji': '📦',
        'description': 'Increases the storage capacity for all your resources.',
        'base_cost': {'wood': 200, 'stone': 150}, 'cost_multiplier': 2.2,
        'base_time_seconds': 45, 'time_multiplier': 1.8,
        'effects': {'type': 'storage', 'value_per_level': 500}
    },
    'sawmill': {
        'id': 'building_sawmill_level', 'name': 'Sawmill', 'emoji': '🌲',
        'description': 'Automatically produces Wood over time.',
        'base_cost': {'wood': 50, 'stone': 100}, 'cost_multiplier': 1.8,
        'base_time_seconds': 30, 'time_multiplier': 1.6,
        'effects': {'type': 'production', 'resource': 'wood_prod_rate', 'value_per_level': 20}
    },
    'quarry': {
        'id': 'building_quarry_level', 'name': 'Stone Quarry', 'emoji': '🪨',
        'description': 'Automatically produces Stone over time.',
        'base_cost': {'wood': 100, 'stone': 50}, 'cost_multiplier': 1.8,
        'base_time_seconds': 30, 'time_multiplier': 1.6,
        'effects': {'type': 'production', 'resource': 'stone_prod_rate', 'value_per_level': 20}
    },
    'ironmine': {
        'id': 'building_ironmine_level', 'name': 'Iron Mine', 'emoji': '🔩',
        'description': 'Automatically produces Iron over time.',
        'base_cost': {'wood': 150, 'stone': 150}, 'cost_multiplier': 2.0,
        'base_time_seconds': 40, 'time_multiplier': 1.7,
        'effects': {'type': 'production', 'resource': 'iron_prod_rate', 'value_per_level': 10}
    }
}

# --- UNIT DATA BLUEPRINT ---
# This block was likely missing from your previous file.
UNIT_DATA = {
    'infantry': {
        'id': 'unit_infantry_count',
        'name': 'Infantry',
        'emoji': '🪖',
        'description': 'Basic frontline soldiers. Cheap and fast to train.',
        'stats': {'attack': 5, 'defense': 3, 'health': 10, 'power': 1},
        'cost': {'food': 50, 'iron': 10},
