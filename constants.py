# constants.py
# System 9 Upgrade: Introduces the Alliance data model and configuration.

from datetime import datetime, timedelta, timezone

# === PLAYER SCHEMA ===
SHEET_COLUMN_HEADERS = [
    'user_id', 'commander_name', 'alliance_id', # <-- NEW: Link to Alliance
    ...
    'shield_finish_time', 'attack_queue_target_id', 'attack_queue_finish_time',
...
INITIAL_PLAYER_STATS = {
    'alliance_id': '', # Player starts with no alliance
...
ALLIANCE_CONFIG = {
    ...
    'create_cost': {'diamonds': 100} # Example cost to create an alliance
}


# --- All other constants (MENU, BUILDING, UNIT, COMBAT) remain unchanged ---
MENU_BASE = "🏠 Base"
MENU_BUILD = "⚒️ Build"
MENU_TRAIN = "🪖 Train"
...
BUILDING_DATA = {
    ...
    'research_lab': {'id': 'building_research_lab_level', 'name': 'Research Lab', 'emoji': '🔬', 'description': 'Unlocks new technologies to enhance your empire.', 'base_cost': {'wood': 300, 'stone': 400}, 'cost_multiplier': 2.2, 'base_time_seconds': 120, 'time_multiplier': 1.9, 'effects': {}},
...
RESEARCH_DATA = {
    'logistics': {'id': 'research_logistics_unlocked', 'name': 'Advanced Logistics', 'emoji': '📈', 'description': 'Permanently increases all non-food resource production by 10%.', 'cost': {'wood': 1000, 'stone': 1000, 'iron': 500}, 'research_time_seconds': 600, 'required_lab_level': 1, 'effects': [{'type': 'production_multiplier', 'resource': 'wood_prod_rate', 'multiplier': 1.10}, {'type': 'production_multiplier', 'resource': 'stone_prod_rate', 'multiplier': 1.10}, {'type': 'production_multiplier', 'resource': 'iron_prod_rate', 'multiplier': 1.10},]},
    'weaponry': {'id': 'research_weaponry_unlocked', 'name': 'Improved Weaponry', 'emoji': '⚔️', 'description': 'Permanently increases the attack power of all Infantry units by 2 points.', 'cost': {'iron': 1500}, 'research_time_seconds': 900, 'required_lab_level': 2, 'effects': [{'type': 'unit_stat_bonus', 'unit': 'infantry', 'stat': 'attack', 'bonus': 2}]}
}