...
async def tick_resources(context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        for player_id in players:
            ...
            # Update player data
            update_player_data(player_id, "resources_wood", new_wood)
            update_player_data(player_id, "resources_stone", new_stone)
            update_player_data(player_id, "resources_food", new_food)
            update_player_data(player_id, "resources_gold", new_gold)
            update_player_data(player_id, "energy", new_energy)
